...
import com.example.serena.API.IResponCreatedSerenBox
...
class SerenBoxDetailFragment(private val mainActivity: MainActivity, private val serenID: String) : Fragment(
    R.layout.fragment_seren_box_detail) {
