...
class EmotionDetectionResultFragment(private val data: IUserEmotionsResData, private val mainActivity: MainActivity) : Fragment(
    R.layout.fragment_emotion_detection_result) {
